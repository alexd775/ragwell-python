...
from ...models.ingestion_job_list_response import IngestionJobListResponse
...
def _get_kwargs(
    ...
    *,
    ...
    status: list[IngestionJobStatus] | Unset = UNSET,
) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/projects/{project_id}/jobs".format(
...
) -> ErrorResponse | IngestionJobListResponse | None:
    if response.status_code == 200:
        response_200 = IngestionJobListResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorResponse | IngestionJobListResponse]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        status (list[IngestionJobStatus] | Unset):
...
def sync(
    ...
    *,
    ...
    Returns:
        ErrorResponse | IngestionJobListResponse
    """
