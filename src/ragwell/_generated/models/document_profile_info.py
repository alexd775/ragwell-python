...
T = TypeVar("T", bound="DocumentProfileInfo")


@_attrs_define
class DocumentProfileInfo:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        document_profile_info.additional_properties = d
        return document_profile_info
